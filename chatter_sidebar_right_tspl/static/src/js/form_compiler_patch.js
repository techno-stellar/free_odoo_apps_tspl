...
const CHATTER_CONTAINER_SELECTOR =
    ".o-mail-Form-chatter:not(.o-isInFormSheetBg), .o-mail-ChatterContainer:not(.o-isInFormSheetBg)";
const CHATTER_COMPONENT_SELECTOR = "t[t-component='__comp__.mailComponents.Chatter']";
...
patch(FormCompiler.prototype, {
    ...
    compile(node, params) {
        ...
        const chatterContainer = res.querySelector(CHATTER_CONTAINER_SELECTOR);
        if (!chatterContainer) {
            return res;
        }

        const chatterComponent = chatterContainer.querySelector(CHATTER_COMPONENT_SELECTOR);
        if (chatterComponent) {
